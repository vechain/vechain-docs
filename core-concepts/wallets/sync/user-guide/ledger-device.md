...
## Import Ledger Device <a href="#import-ledger-device" id="import-ledger-device"></a>
...
## Remove Ledger Device <a href="#remove-ledger-device" id="remove-ledger-device"></a>
...
### Check account info failed <a href="#check-account-info-failed" id="check-account-info-failed"></a>
...
The easiest way to identify the issue is [import your ledger device](ledger-device.md#import-ledger-device) again. if it appears two separate wallets then you can reset your device to get your wallet accessible.
