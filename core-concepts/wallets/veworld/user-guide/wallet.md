...
VeWorld is available as a mobile wallet and as a browser extension. 
The process to create a wallet is similar, the following sections will cover the differences
