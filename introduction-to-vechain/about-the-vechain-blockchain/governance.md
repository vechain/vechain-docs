...
{% hint style="info" %}
Explore VeChain's on-chain governance and view past or future proposals, visit [VeVote](https://vevote.vechain.org/home), VeChain's voting platform. VeVote enhances ecosystem transparency and decentralization. Specific documentation can be found here: [docs.vevote.vechain.org](docs.vevote.vechain.org) together with details about the new goverance.
{% endhint %}
