...
### staker.sol <a href="#authority-sol" id="authority-sol"></a>

[staker.sol](https://staker.sol)[ ](https://github.com/vechain/thor/blob/master/builtin/gen/authority.sol)is related to the delegated proof of stake (dPoS) consensus mechanism. The Staker contract manages a list of validators that are responsible for packing transactions into a block. This contract replaces [#authority-sol-1](built-in-contracts.md#authority-sol-1 "mention") after the hayabusa fork and transition period. The contract also allows adding delegations. For more information please refer to the [relevant VIP](https://github.com/vechain/VIPs/blob/master/vips/VIP-253.md).&#x20;

**Address** :0x00000000000000000000000000005374616b6572

[Code](https://github.com/vechain/thor/blob/master/builtin/gen/staker.sol) / [ABI](https://raw.githubusercontent.com/vechain/b32/master/ABIs/staker.json)&#x20;
