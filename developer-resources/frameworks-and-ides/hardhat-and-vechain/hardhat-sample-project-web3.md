...
To be able to run the tests on Vechain you need Thor installed, which is Vechain's node implementation. We have a detailed guide on how to do that [here](https://github.com/vechain/vechain-docs/blob/add-sdk-docs/developer-resources/frameworks-and-ides/hardhat-and-vechain/broken-reference/README.md).
