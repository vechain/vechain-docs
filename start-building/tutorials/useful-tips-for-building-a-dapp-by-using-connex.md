...
>   &#xNAN;_&#x65;xample:_\
>   &#xNAN;_\[{"ConA": "A"}, {"ConB": "B", "ConC": "C"}] is 'ConA=A `OR` (ConB=B `AND` ConC=C)'_
...
1. Need to know the _**Base gas price**_ from [params](https://github.com/vechain/vechain-docs/blob/add-sdk-docs/start-building/tutorials/broken-reference/README.md) contract
